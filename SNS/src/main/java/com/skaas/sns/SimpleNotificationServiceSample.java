...
public class SimpleNotificationServiceSample {
	...
	public static void main(String[] args) {
        ...
        AmazonSNS sns = AmazonSNSClientBuilder.standard().withRegion(Regions.US_WEST_2).build();
        ...
        SubscribeRequest subRequest = new SubscribeRequest(topicArn, "email", "kalki@skaas.guru");
...
//        String phoneNumber = "+918778171172";
